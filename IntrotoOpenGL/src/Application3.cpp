...
void Application3::Update(float deltaTime)
{
	m_camera->Update(deltaTime);
}

void Application3::Draw()
{
...
//Now modified simpletextureplane and createtextureshader for advanced texture tutorial
void Application3::GenerateSimpleTexturePlane()
{
...
void Application3::CreateSimpleShader()
{
...
void Application3::CreateTextureShader()
{
	const char* vsSource = "#version 410\n \
							layout(location=0) in vec4 Position; \
...
void Application3::CreateSimpleObjShader()
{
	const char* vsSource = "#version 410\n \
...
void Application3::createOpenGLBuffers(std::vector<tinyobj::shape_t>& shapes)
{
...
void Application3::cleanupOpenGLBuffers(std::vector<tinyobj::shape_t>& shapes)
{
	m_gl_info.resize(shapes.size());
